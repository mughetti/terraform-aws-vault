...
source "amazon-ebs" "amazon-linux-2-ami" {
  ...
  ami_name        = "vault-consul-amazon-linux-2-{{ clean_resource_name `${timestamp()}` }}-${uuidv4()}"
...
source "amazon-ebs" "ubuntu16-ami" {
  ...
  ami_name        = "vault-consul-ubuntu16-{{ clean_resource_name `${timestamp()}` }}-${uuidv4()}"
  instance_type   = "t2.micro"
  region          = "${var.aws_region}"
...
source "amazon-ebs" "ubuntu18-ami" {
  ...
  ami_name        = "vault-consul-ubuntu18-{{ clean_resource_name `${timestamp()}` }}-${uuidv4()}"
  instance_type   = "t2.micro"
  region          = "${var.aws_region}"
